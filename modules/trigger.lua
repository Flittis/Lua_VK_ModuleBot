...
function obj.func(msg)    -- creating callback function
    ...
    if(timeout[msg.peer_id] == nil and msg.out == false and isInArray(stickerTriggerWords, msg.body:lower()) and (not stickerTriggerChats[1] or isInArray(stickerTriggerChats, msg.chat_id))) then
