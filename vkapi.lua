...
function vk.longpollStart()
    ...
    if (lpGet and lpGet.error) then
        print(('[ERROR]\tError occured when getting LongPoll server'))

        vk.connectionErrors = vk.connectionErrors + 1
        if vk.connectionErrors >= 3 then return end
