...
И да, вы можете с легкостью удалить любой модуль из папки _**modules**_, или переместить куда-то в другую папку, для отключения определенного скрипта или бота.
